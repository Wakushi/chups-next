...
export default function Hero({ bookings }: { bookings: Booking[] }) {
  ...
  if (!nextShow) {
    return (
      <div className="p-4 flex items-center justify-center flex-col gap-1 min-h-[100vh] bg-slate-400 overflow-hidden bg-hero-image bg-cover bg-center">
  ...
  return (
    <div className="p-4 flex items-center justify-center flex-col gap-1 h-[100vh] bg-hero-image bg-cover bg-center relative">
