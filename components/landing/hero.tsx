...
export default function Hero() {
  return (
    <div className="p-4 flex items-center justify-center flex-col gap-1 w-auto min-h-[100vh] bg-hero-image bg-cover bg-center">
      ...
      <h2
        className={`${playfairDisplay.className} uppercase text-[4rem] text-center leading-[0.9] my-6 drop-shadow-3xl animate-fade-in-zoom opacity-0`}
      >
        Mystère au cabaret
      </h2>
      <p className="text-center drop-shadow-3xl">
